	...
	public class CCLF4Specs
	{
		...
		)
		{
			return new List<IFieldSpec>()
			{
				...
				new FieldSpecCategorical(CCLFData.CLM_PROD_TYPE_CD, CCLFData.LIST_CLM_PROD_TYPE_CD, false, null, 1),
				new FieldSpecContinuousNumeric(CCLFData.CLM_VAL_SQNC_NUM, new DistUniform(0, 99), 0, false, null, 2),
				new FieldSpecCategorical(CCLFData.CLM_DGNS_CD, PRNCPL_DGNS_CD, false, null, 7),
				...
				new FieldSpecCategorical(CCLFData.CLM_POA_IND, CCLFData.LIST_CLM_POA_IND, false, null, 7),
