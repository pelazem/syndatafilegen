	...
	public class CCLF5Specs
	{
		...
		)
		{
			return new List<IFieldSpec>()
			{
				...
				new FieldSpecCategorical(CCLFData.CLM_TYPE_CD, CCLFData.LIST_CCLF5_CLM_TYPE_CD, false, null, 2),
				...
				new FieldSpecCategorical(CCLFData.RNDRG_PRVDR_TYPE_CD, CCLFData.LIST_RNDRG_PRVDR_TYPE_CD, false, null, 3),
				new FieldSpecCategorical(CCLFData.RNDRG_PRVDR_FIPS_ST_CD, CCLFData.LIST_FIPS_STATE_CD, false, null, 2),
				new FieldSpecCategorical(CCLFData.CLM_PRVDR_SPCLTY_CD, CCLFData.LIST_CLM_PRVDR_SPCLTY_CD, false, null, 2),
				...
				new FieldSpecCategorical(CCLFData.CLM_LINE_PRMRY_PYR_CD, CCLFData.LIST_PRMRY_PYR_CD, false, null, 1),
				new FieldSpecCategorical(CCLFData.CLM_LINE_DGNS_CD, PRNCPL_DGNS_CD, false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_RNDRG_PRVDR_TAX_NUM, () => RNG.GetUniform(100000000, 9999999999).ToString(), false, null, 10),
				new FieldSpecDynamic(CCLFData.RNDRG_PRVDR_NPI_NUM, () => RNG.GetUniform(1000000000, 9999999999).ToString(), false, null, 10),
				...
				new FieldSpecDynamic(CCLFData.CLM_DGNS_1_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_2_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_3_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_4_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_5_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_6_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_7_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
				new FieldSpecDynamic(CCLFData.CLM_DGNS_8_CD, () => CCLFGenerator.GetICD10Code(), false, null, 7),
