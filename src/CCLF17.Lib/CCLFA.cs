	...
	public class CCLFASpecs
	{
		public static List<IFieldSpec> GetFieldSpecs(List<Category> CUR_CLM_UNIQ_ID, DateTime dateStartClaimAdmission, DateTime dateEndClaimAdmission)
		{
			return new List<IFieldSpec>()
			{
				...
				new FieldSpecContinuousDateTime(CCLFData.CLM_ACTV_CARE_FROM_DT, dateStartClaimAdmission, dateEndClaimAdmission, false, "{0:yyyy-MM-dd}", 10),
				new FieldSpecCategorical(CCLFData.CLM_NGACO_PBPMT_SW, CCLFData.LIST_YN, false, null, 1),
				new FieldSpecCategorical(CCLFData.CLM_NGACO_PDSCHRG_HCBS_SW, CCLFData.LIST_YN, false, null, 1),
				new FieldSpecCategorical(CCLFData.CLM_NGACO_SNF_WVR_SW, CCLFData.LIST_YN, false, null, 1),
				new FieldSpecCategorical(CCLFData.CLM_NGACO_TLHLTH_SW, CCLFData.LIST_YN, false, null, 1),
				new FieldSpecCategorical(CCLFData.CLM_NGACO_CPTATN_SW, CCLFData.LIST_YN, false, null, 1),
